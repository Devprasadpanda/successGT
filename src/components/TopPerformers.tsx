...
const badgeStyles: Record<BadgeKey, {
  ...
  gold: {
    ...
    badge: "bg-yellow-100 text-yellow-700 border-yellow-300 dark:bg-yellow-900/40 dark:text-yellow-300 dark:border-yellow-700/50",
    rankBg: "bg-yellow-500",
    scoreBg: "bg-yellow-500 text-white dark:bg-yellow-600",
  },
  silver: {
    border: "border-slate-300/60 dark:border-slate-600/60",
    bg: "bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-800/60 dark:to-slate-900/60",
    icon: "text-slate-500 dark:text-slate-400",
    badge: "bg-slate-100 text-slate-700 border-slate-300 dark:bg-slate-700/50 dark:text-slate-300 dark:border-slate-600/50",
    rankBg: "bg-slate-400",
    scoreBg: "bg-slate-500 text-white dark:bg-slate-600",
  },
  bronze: {
    ...
    badge: "bg-orange-100 text-orange-700 border-orange-300 dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-700/50",
    rankBg: "bg-orange-500",
    scoreBg: "bg-orange-500 text-white dark:bg-orange-600",
  },
  normal: {
